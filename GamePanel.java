...
public class GamePanel extends JPanel {
	...
	private void drawInvaders(Graphics g) {
		for(BigSwirlingInvader next : game.getInvaders()) {
			drawInvader(g, next);
		}
	}
	...
	private void drawInvader(Graphics g, BigSwirlingInvader i) {
		Color savedCol = g.getColor();
		g.setColor(BigSwirlingInvader.COLOR);
		g.fillOval(i.getX() - BigSwirlingInvader.SIZE_X / 2, i.getY() - BigSwirlingInvader.SIZE_Y / 2, BigSwirlingInvader.SIZE_X, BigSwirlingInvader.SIZE_Y);
		g.setColor(savedCol);
	}
